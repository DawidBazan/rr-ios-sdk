...
{
    if ([key isEqualToString:NSStringFromSelector(@selector(products))] && [value isKindOfClass:[NSArray class]]) {
        self.products = [RCHRecommendedProduct rch_objectsFromArray:value];
        return NO;
    }
